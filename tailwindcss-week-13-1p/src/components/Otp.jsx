...
function SubOtpBox({reference, onDone,goBack}){
    ...
    return <div>
        <input value={inputBoxVal} ref={reference} onKeyUp={(e) =>{
            ...
            const val = e.target.value //get the current dom element 
        ...
        }} type="text" className="m-2 w-[40px] h-[50px] rounded-2xl bg-blue-500 outline-none px-4 text-white"></input>
    </div>
}